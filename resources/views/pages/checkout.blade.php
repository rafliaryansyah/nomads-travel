            ...
            <div class="row">
                        ...
                        <div class="attendee">
                            <table class="table table-responsive-sm text-center">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <img src="{{ url('frontend/assets/images/avatar-1.png') }}" alt="Name Account" height="60">
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <img src="{{ url('frontend/assets/images/avatar-2.png') }}" alt="Name Account" height="60">
                                        </td>
                                        <td class="align-middle">
                                            Ifih Lutfiah
                                        </td>
                ...
                <div class="col-lg-4">
                    <div class="card card-details card-right">
                        ...
                        <table class="trip-informations">
                            <tr>
                                ...
                                <th width="50%" class="text-right">2 Person</th>
                            </tr>
                            <tr>
                                <th width="50%">Additional VISA</th>
                                <th width="50%" class="text-right">$ 190,00</th>
                            </tr>
                            <tr>
                                <th width="50%">Triple Price</th>
                                <th width="50%" class="text-right">$ 80,00 / Person</th>
                            </tr>
                            <tr>
                                <th width="50%">Sub Total</th>
                                <th width="50%" class="text-right">$ 280,00</th>
                            </tr>
                            <tr>
                    ...
                    <div class="join-cointainer">
                        <a href="{{ route('checkout-success') }}" class="btn btn-block btn-join-now py-2">
                            I Have Payment
                        </a>
                    </div>
