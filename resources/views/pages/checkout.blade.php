            ...
            <div class="row">
                    ...
                    <div class="card card-details mt-1">
                        ...
                        <div class="member mt-3">
                            ...
                            <form method="POST" action="{{ route('checkout-create', $item->id) }}" class="form-inline">
                                ...
                                <label for="nationaility" class="sr-only">Nationaility</label>
                                <input
                                 type="text"
                                 name="nationaility"
                                 class="form-control mb-2 mr-sm-2"
                ...
                <div class="col-lg-4">
                    <div class="card card-details card-right">
                        ...
                        <table class="trip-informations">
                            ...
                            <tr>
                                ...
                                <th width="50%" class="text-right">$ {{ $item->additional_visa }},00</th>
                            </tr>
                            <tr>
                                <th width="50%">Triple Price</th>
                                <th width="50%" class="text-right">$ {{ $item->travel_package->price }},00 / Person</th>
                            </tr>
                            <tr>
                                <th width="50%">Sub Total</th>
                                <th width="50%" class="text-right">$ {{ $item->transaction_total }},00</th>
                            </tr>
                            <tr>
                    ...
                    <div class="join-cointainer">
                        <a href="{{ route('checkout-success', $item->id) }}" class="btn btn-block btn-join-now py-2">
                            I Have Payment
                        </a>
                    </div>
